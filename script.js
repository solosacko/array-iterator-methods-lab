...
// Array.veryOldInventor.filter (for those who were born in1500's)
const veryOldInventors = inventors.filter(inventor => (inventor >= 1500 && inventor < 1600 ));
...
// Enter your solution code here:
let isAdultPeople = devs.some(person => person.age >= 18);
...
console.log(isEveryone19OrOlder); // Output: false
...
console.log(commentById); // {id: 823423, text: "Love this article!"}
...
console.log(totalYearsLived) // Output Total years lived by all inventors
